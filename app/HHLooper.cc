...
histograms.addHistogram("fatJet1Pt",          "; p_{T}^{j1} (GeV); Events",           200,   300.,   2300.,  [&]() { 
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos) return hh.fatJet1Pt_JESUp_Abs_2016(); 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos) return hh.fatJet1Pt_JESUp_Abs_2017(); 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos) return hh.fatJet1Pt_JESUp_Abs_2018(); 
    else if(syst_name.find("JESUp_BBEC1") != std::string::npos) return hh.fatJet1Pt_JESUp_BBEC1();
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos) return hh.fatJet1Pt_JESUp_BBEC1_2016(); 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos) return hh.fatJet1Pt_JESUp_BBEC1_2017(); 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos) return hh.fatJet1Pt_JESUp_BBEC1_2018(); 
    else if(syst_name.find("JESUp_EC2") != std::string::npos) return hh.fatJet1Pt_JESUp_EC2();
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos) return hh.fatJet1Pt_JESUp_EC2_2016(); 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos) return hh.fatJet1Pt_JESUp_EC2_2017(); 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos) return hh.fatJet1Pt_JESUp_EC2_2018(); 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos) return hh.fatJet1Pt_JESUp_HF_2016(); 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos) return hh.fatJet1Pt_JESUp_HF_2017(); 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos) return hh.fatJet1Pt_JESUp_HF_2018(); 
    else if(syst_name.find("JESUp_RelBal") != std::string::npos) return hh.fatJet1Pt_JESUp_RelBal();
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos) return hh.fatJet1Pt_JESUp_RelSample_2016(); 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos) return hh.fatJet1Pt_JESUp_RelSample_2017(); 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos) return hh.fatJet1Pt_JESUp_RelSample_2018(); 
    else if(syst_name.find("JESDown_Abs") != std::string::npos) return hh.fatJet1Pt_JESDown_Abs();
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos) return hh.fatJet1Pt_JESDowb_Abs_2016(); 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos) return hh.fatJet1Pt_JESDowb_Abs_2017(); 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos) return hh.fatJet1Pt_JESDowb_Abs_2018(); 
    else if(syst_name.find("JESDown_BBEC1") != std::string::npos) return hh.fatJet1Pt_JESDown_BBEC1();
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos) return hh.fatJet1Pt_JESDown_BBEC1_2016(); 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos) return hh.fatJet1Pt_JESDown_BBEC1_2017(); 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos) return hh.fatJet1Pt_JESDown_BBEC1_2018(); 
    else if(syst_name.find("JESDown_EC2") != std::string::npos) return hh.fatJet1Pt_JESDown_EC2();
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos) return hh.fatJet1Pt_JESDown_EC2_2016(); 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos) return hh.fatJet1Pt_JESDown_EC2_2017(); 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos) return hh.fatJet1Pt_JESDown_EC2_2018(); 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos) return hh.fatJet1Pt_JESDown_HF_2016(); 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos) return hh.fatJet1Pt_JESDown_HF_2017(); 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos) return hh.fatJet1Pt_JESDown_HF_2018(); 
    else if(syst_name.find("JESDown_RelBal") != std::string::npos) return hh.fatJet1Pt_JESDown_RelBal();
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos) return hh.fatJet1Pt_JESDown_RelSample_2016(); 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos) return hh.fatJet1Pt_JESDown_RelSample_2017(); 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos) return hh.fatJet1Pt_JESDown_RelSample_2018(); 
...
histograms.addHistogram("fatJet2Pt",          "; p_{T}^{j2} (GeV); Events",           200,   300.,   2300.,  [&]() { 
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_Abs_2016(); 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_Abs_2017(); 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_Abs_2018(); 
    else if(syst_name.find("JESUp_BBEC1") != std::string::npos) return hh.fatJet2Pt_JESUp_BBEC1();
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_BBEC1_2016(); 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_BBEC1_2017(); 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_BBEC1_2018(); 
    else if(syst_name.find("JESUp_EC2") != std::string::npos) return hh.fatJet2Pt_JESUp_EC2();
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_EC2_2016(); 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_EC2_2017(); 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_EC2_2018(); 
    else if(syst_name.find("JESUp_FlavQCD") != std::string::npos) return hh.fatJet2Pt_JESUp_FlavQCD();
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_FlavQCD_2016(); 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_FlavQCD_2017(); 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_FlavQCD_2018(); 
    else if(syst_name.find("JESUp_HF") != std::string::npos) return hh.fatJet2Pt_JESUp_HF();
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_HF_2016(); 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_HF_2017(); 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_HF_2018(); 
    else if(syst_name.find("JESUp_RelBal") != std::string::npos) return hh.fatJet2Pt_JESUp_RelBal();
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos) return hh.fatJet2Pt_JESUp_RelSample_2016(); 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos) return hh.fatJet2Pt_JESUp_RelSample_2017(); 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos) return hh.fatJet2Pt_JESUp_RelSample_2018(); 
    else if(syst_name.find("JESDown_Abs") != std::string::npos) return hh.fatJet2Pt_JESDown_Abs();
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos) return hh.fatJet2Pt_JESDowb_Abs_2016(); 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos) return hh.fatJet2Pt_JESDowb_Abs_2017(); 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos) return hh.fatJet2Pt_JESDowb_Abs_2018(); 
    else if(syst_name.find("JESDown_BBEC1") != std::string::npos) return hh.fatJet2Pt_JESDown_BBEC1();
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos) return hh.fatJet2Pt_JESDown_BBEC1_2016(); 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos) return hh.fatJet2Pt_JESDown_BBEC1_2017(); 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos) return hh.fatJet2Pt_JESDown_BBEC1_2018(); 
    else if(syst_name.find("JESDown_EC2") != std::string::npos) return hh.fatJet2Pt_JESDown_EC2();
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos) return hh.fatJet2Pt_JESDown_EC2_2016(); 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos) return hh.fatJet2Pt_JESDown_EC2_2017(); 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos) return hh.fatJet2Pt_JESDown_EC2_2018(); 
    else if(syst_name.find("JESDown_FlavQCD") != std::string::npos) return hh.fatJet2Pt_JESDown_FlavQCD();
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos) return hh.fatJet2Pt_JESDown_FlavQCD_2016(); 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos) return hh.fatJet2Pt_JESDown_FlavQCD_2017(); 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos) return hh.fatJet2Pt_JESDown_FlavQCD_2018(); 
    else if(syst_name.find("JESDown_HF") != std::string::npos) return hh.fatJet2Pt_JESDown_HF();
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos) return hh.fatJet2Pt_JESDown_HF_2016(); 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos) return hh.fatJet2Pt_JESDown_HF_2017(); 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos) return hh.fatJet2Pt_JESDown_HF_2018(); 
    else if(syst_name.find("JESDown_RelBal") != std::string::npos) return hh.fatJet2Pt_JESDown_RelBal();
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos) return hh.fatJet2Pt_JESDown_RelSample_2016(); 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos) return hh.fatJet2Pt_JESDown_RelSample_2017(); 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos) return hh.fatJet2Pt_JESDown_RelSample_2018(); 
...
//Pre-selection cuts
  cutflow.addCut("CutWeight", [&](){ return 1; },  [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_Abs_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_Abs_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_Abs_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_Abs_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_Abs_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_Abs_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_EC2_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_EC2_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_EC2_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_EC2_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_EC2_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_EC2_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_FlavQCD_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_FlavQCD_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_FlavQCD_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_FlavQCD_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_FlavQCD_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_FlavQCD_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_HF_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_HF_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_HF_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_HF_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_HF_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_HF_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_RelSample_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_RelSample_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_RelSample_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_RelSample_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_RelSample_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_RelSample_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDowb_Abs_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDowb_Abs_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDowb_Abs_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDowb_Abs_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDowb_Abs_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDowb_Abs_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_BBEC1_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_BBEC1_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_BBEC1_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_BBEC1_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_BBEC1_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_BBEC1_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_EC2_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_EC2_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_EC2_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_EC2_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_EC2_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_EC2_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_FlavQCD_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_FlavQCD_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_FlavQCD_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_FlavQCD_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_FlavQCD_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_FlavQCD_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_HF_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_HF_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_HF_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_HF_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_HF_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_HF_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_RelSample_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_RelSample_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_RelSample_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_RelSample_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos) { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_RelSample_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_RelSample_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");} 
...
cutflow.addCutToLastActiveCut("CutfatJetsPt",       [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_Abs_2016() > 300.0 && hh.fatJet2Pt_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_Abs_2017() > 300.0 && hh.fatJet2Pt_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_Abs_2018() > 300.0 && hh.fatJet2Pt_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_BBEC1_2016() > 300.0 && hh.fatJet2Pt_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_BBEC1_2017() > 300.0 && hh.fatJet2Pt_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_BBEC1_2018() > 300.0 && hh.fatJet2Pt_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_EC2_2016() > 300.0 && hh.fatJet2Pt_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_EC2_2017() > 300.0 && hh.fatJet2Pt_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_EC2_2018() > 300.0 && hh.fatJet2Pt_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_FlavQCD_2016() > 300.0 && hh.fatJet2Pt_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_FlavQCD_2017() > 300.0 && hh.fatJet2Pt_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_FlavQCD_2018() > 300.0 && hh.fatJet2Pt_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_HF_2016() > 300.0 && hh.fatJet2Pt_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_HF_2017() > 300.0 && hh.fatJet2Pt_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_HF_2018() > 300.0 && hh.fatJet2Pt_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_RelSample_2016() > 300.0 && hh.fatJet2Pt_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_RelSample_2017() > 300.0 && hh.fatJet2Pt_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESUp_RelSample_2018() > 300.0 && hh.fatJet2Pt_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDowb_Abs_2016() > 300.0 && hh.fatJet2Pt_JESDowb_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDowb_Abs_2017() > 300.0 && hh.fatJet2Pt_JESDowb_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDowb_Abs_2018() > 300.0 && hh.fatJet2Pt_JESDowb_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_BBEC1_2016() > 300.0 && hh.fatJet2Pt_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_BBEC1_2017() > 300.0 && hh.fatJet2Pt_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_BBEC1_2018() > 300.0 && hh.fatJet2Pt_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_EC2_2016() > 300.0 && hh.fatJet2Pt_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_EC2_2017() > 300.0 && hh.fatJet2Pt_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_EC2_2018() > 300.0 && hh.fatJet2Pt_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_FlavQCD_2016() > 300.0 && hh.fatJet2Pt_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_FlavQCD_2017() > 300.0 && hh.fatJet2Pt_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_FlavQCD_2018() > 300.0 && hh.fatJet2Pt_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_HF_2016() > 300.0 && hh.fatJet2Pt_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_HF_2017() > 300.0 && hh.fatJet2Pt_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_HF_2018() > 300.0 && hh.fatJet2Pt_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_RelSample_2016() > 300.0 && hh.fatJet2Pt_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_RelSample_2017() > 300.0 && hh.fatJet2Pt_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.isVBFtag() < 1 && hh.fatJet1Pt_JESDown_RelSample_2018() > 300.0 && hh.fatJet2Pt_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1",       [&](){    
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.980;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin3",       [&](){ 
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_Abs_2016() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_Abs_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_BBEC1_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_EC2_2016() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_EC2_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_EC2_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_FlavQCD_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_HF_2016() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_HF_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_HF_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_RelBal") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelBal() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelBal() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelBal() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_RelBal() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_RelSample_2016() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_RelSample_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_Abs_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_BBEC1_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_BBEC1_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_FlavQCD_2016() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_FlavQCD_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_FlavQCD_2018() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_HF_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
    ...
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return (hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.03 && hh.fatJet2PNetXbb() > 0.950)  && (!((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.950)));//_JESDown_RelSample_2017() > 300.0))  && ((hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.11 && hh.fatJet2PNetXbb() > 0.980)||(hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown() > 0.43 && hh.fatJet2PNetXbb() > 0.950))); 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp95",       [&](){    
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.95;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp92",       [&](){    
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.92;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp9",       [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.9;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp5",       [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.5;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp2",       [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.2;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("SRv8p2Bin1PNetp0",       [&](){
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.43 && hh.fatJet2PNetXbb() > 0.;//_JESDown_RelSample_2018() > 300.0; 
...
cutflow.addCutToLastActiveCut("FailSRv8p2",       [&](){ 
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_Abs_2016() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_Abs_2017() > 300.0; 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_Abs_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_BBEC1_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_EC2_2016() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_EC2_2017() > 300.0; 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_EC2_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_EC2_2018() > 300.0; 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_FlavQCD_2016() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_FlavQCD_2017() > 300.0; 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_FlavQCD_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_HF_2016() > 300.0; 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_HF_2017() > 300.0; 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_HF_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESUp_RelSample_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESUp_RelSample_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_Abs_2016() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_Abs_2017() > 300.0; 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_Abs_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_Abs_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_BBEC1_2016() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_BBEC1_2017() > 300.0; 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_BBEC1_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_BBEC1_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_EC2_2016() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_EC2_2017() > 300.0; 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_EC2_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_EC2_2018() > 300.0; 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_FlavQCD_2016() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_FlavQCD_2017() > 300.0; 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_FlavQCD_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_FlavQCD_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_HF_2016() > 300.0; 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_HF_2017() > 300.0; 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_HF_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_HF_2018() > 300.0; 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2016() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_RelSample_2016() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2017() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_RelSample_2017() > 300.0; 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  return hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_JESDown_RelSample_2018() > 0.03 && hh.fatJet2PNetXbb()< 0.950;//_JESDown_RelSample_2018() > 300.0; 
...
////Top control region
    ...
    else if(syst_name.find("JESUp_Abs_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_Abs_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_Abs_2016())) : 1.0;} 
    else if(syst_name.find("JESUp_Abs_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_Abs_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_Abs_2017())) : 1.0;} 
    else if(syst_name.find("JESUp_Abs_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_Abs_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_Abs_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESUp_BBEC1_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_BBEC1_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_BBEC1_2016())) : 1.0;} 
    else if(syst_name.find("JESUp_BBEC1_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_BBEC1_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_BBEC1_2017())) : 1.0;} 
    else if(syst_name.find("JESUp_BBEC1_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_BBEC1_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_BBEC1_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESUp_EC2_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_EC2_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_EC2_2016())) : 1.0;} 
    else if(syst_name.find("JESUp_EC2_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_EC2_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_EC2_2017())) : 1.0;} 
    else if(syst_name.find("JESUp_EC2_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_EC2_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_EC2_2018())) : 1.0;} 
    ...
    //else if(syst_name.find("JESUp_FlavQCD_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_FlavQCD_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_FlavQCD_2016())) : 1.0;} 
    //else if(syst_name.find("JESUp_FlavQCD_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_FlavQCD_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_FlavQCD_2017())) : 1.0;} 
    //else if(syst_name.find("JESUp_FlavQCD_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_FlavQCD_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_FlavQCD_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESUp_HF_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_HF_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_HF_2016())) : 1.0;} 
    else if(syst_name.find("JESUp_HF_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_HF_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_HF_2017())) : 1.0;} 
    else if(syst_name.find("JESUp_HF_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_HF_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_HF_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESUp_RelSample_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_RelSample_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_RelSample_2016())) : 1.0;} 
    else if(syst_name.find("JESUp_RelSample_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_RelSample_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_RelSample_2017())) : 1.0;} 
    else if(syst_name.find("JESUp_RelSample_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESUp_RelSample_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESUp_RelSample_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESDown_Abs_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDowb_Abs_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDowb_Abs_2016())) : 1.0;} 
    else if(syst_name.find("JESDown_Abs_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDowb_Abs_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDowb_Abs_2017())) : 1.0;} 
    else if(syst_name.find("JESDown_Abs_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDowb_Abs_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDowb_Abs_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESDown_BBEC1_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_BBEC1_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_BBEC1_2016())) : 1.0;} 
    else if(syst_name.find("JESDown_BBEC1_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_BBEC1_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_BBEC1_2017())) : 1.0;} 
    else if(syst_name.find("JESDown_BBEC1_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_BBEC1_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_BBEC1_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESDown_EC2_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_EC2_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_EC2_2016())) : 1.0;} 
    else if(syst_name.find("JESDown_EC2_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_EC2_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_EC2_2017())) : 1.0;} 
    else if(syst_name.find("JESDown_EC2_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_EC2_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_EC2_2018())) : 1.0;} 
    ...
    //if(syst_name.find("JESDown_FlavQCD_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_FlavQCD_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_FlavQCD_2016())) : 1.0;} 
    //if(syst_name.find("JESDown_FlavQCD_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_FlavQCD_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_FlavQCD_2017())) : 1.0;} 
    //if(syst_name.find("JESDown_FlavQCD_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_FlavQCD_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_FlavQCD_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESDown_HF_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_HF_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_HF_2016())) : 1.0;} 
    else if(syst_name.find("JESDown_HF_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_HF_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_HF_2017())) : 1.0;} 
    else if(syst_name.find("JESDown_HF_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_HF_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_HF_2018())) : 1.0;} 
    ...
    else if(syst_name.find("JESDown_RelSample_2016") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_RelSample_2016()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_RelSample_2016())) : 1.0;} 
    else if(syst_name.find("JESDown_RelSample_2017") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_RelSample_2017()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_RelSample_2017())) : 1.0;} 
    else if(syst_name.find("JESDown_RelSample_2018") != std::string::npos)  { return isTTJets ? (TopTagSF("0.46", year_, hh.fatJet1Pt_JESDown_RelSample_2018()) * TopTagSF("0.46", year_, hh.fatJet2Pt_JESDown_RelSample_2018())) : 1.0;} 
