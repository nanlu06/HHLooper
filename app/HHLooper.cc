...
histograms.addHistogram("ptj1_over_mhh",       "; p_{T}^{j1}/m_{HH}; Events",         200,   0.,   10.,    [&]() { return  hh.fatJet1PtOverMHH(); } );
histograms.addHistogram("ptj2_over_mhh",       "; p_{T}^{j2}/m_{HH}; Events",         200,   0.,   10.,    [&]() { return  hh.fatJet2PtOverMHH(); } );
...
cutflow.addCut("CutWeight", [&](){ return 1; },  [&](){
    ...
    float total_weight = isData ?  lumi :lumi * hh.l1PreFiringWeight() * hh.puWeight() * hh.xsecWeight() * (isHH? hh.weight() : hh.genWeight()) * (isTTJets ? 2.0*ttjets_sf.getScaleFactorsFit(year_, hh.hh_pt(), 0) : 1.0);
