...
{    
    ...
    */  
    ...
    //trigger eff SF uncertainty
	  ...
	  float corrup = trig_sf.get_unc_ratio(hh.fatJet1Pt(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0,  hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"up");
	  //cout<<"corr up - "<<corrup<<endl;
	  return corrup;});
    ...
    cutflow.addWgtSyst("triggerEffSF"+year_+"bin3Up", [&](){
        float trig_sf_weight = trig_sf.get_unc_ratio(hh.fatJet1Pt(), hh.fatJet1Mass(), hh.fatJet1PNetXbb(), hh.fatJet2Pt(), hh.fatJet2Mass(), hh.fatJet2PNetXbb(), 1, 3,  hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2(), year_, isHH,"nom");
