...
//Pre-selection cuts
  cutflow.addCut("CutWeight", [&](){ return 1; },  [&](){
    ...
    else if(syst_name == "JESUp_BBEC1") { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_BBEC1(), year_, isHH,"nom");}
    else if(syst_name == "JESUp_BBEC1_2016" && year_=="2016") { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2016(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2016(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_BBEC1_2016(), year_, isHH,"nom");} 
    else if(syst_name == "JESUp_BBEC1_2017" && year_=="2017") { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2017(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2017(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_BBEC1_2017(), year_, isHH,"nom");} 
    else if(syst_name == "JESUp_BBEC1_2018" && year_=="2018") { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESUp_BBEC1_2018(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESUp_BBEC1_2018(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_BBEC1_2018(), year_, isHH,"nom");} 
    ...
    else if(syst_name == "JESDown_RelBal") { total_weight = total_weight * trig_sf.getTrigEffEvt(hh.fatJet1Pt_JESDown_RelBal(), hh.fatJet1MassSD(), hh.fatJet1PNetXbb(), hh.fatJet2Pt_JESDown_RelBal(), hh.fatJet2MassSD(), hh.fatJet2PNetXbb(), 0, 0, hh.disc_qcd_and_ttbar_Run2_enhanced_v8p2_RelBal(), year_, isHH,"nom");}
...
cutflow.addCutToLastActiveCut("CutfatJetsPt",       [&](){
    ...
    else if(syst_name == "JESUp_BBEC1_2016" && year_=="2016")  return hh.isVBFtag_BBEC1_2016() < 1 && hh.fatJet1Pt_JESUp_BBEC1_2016() > 300.0 && hh.fatJet2Pt_JESUp_BBEC1_2016() > 300.0; 
    ...
    else if(syst_name == "JESDown_EC2_2018" && year_=="2018")  return hh.isVBFtagfatJet1Pt_JESDown_EC2_2018() < 1 && hh.fatJet1Pt_JESDown_EC2_2018() > 300.0 && hh.fatJet2Pt_JESDown_EC2_2018() > 300.0; 
