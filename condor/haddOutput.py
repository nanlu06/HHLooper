...
os.system("mkdir -p hists/yield_AN_sr_sys_010222_nominal_nosys" )
os.system("mkdir -p hists/yield_AN_sr_sys_010222_nominal_nosys/combine" )
os.system("mkdir -p hists/yield_AN_sr_sys_010222_nominal_nosys/2016" )
os.system("mkdir -p hists/yield_AN_sr_sys_010222_nominal_nosys/2017" )
os.system("mkdir -p hists/yield_AN_sr_sys_010222_nominal_nosys/2018" )
os.system("hadd -k -f hists/yield_AN_sr_sys_010222_nominal_nosys/combine/data.root condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2016/data.root condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2017/data.root condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2018/data.root")
os.system("cp condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2016/data.root hists/yield_AN_sr_sys_010222_nominal_nosys/2016/data.root")
os.system("cp condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2017/data.root hists/yield_AN_sr_sys_010222_nominal_nosys/2017/data.root")
os.system("cp condor_output/yield_AN_sr_sys_010222_nominal_nosys_data/2018/data.root hists/yield_AN_sr_sys_010222_nominal_nosys/2018/data.root")
for tag in Tags:
    ...
    os.system(mkdircomm)
    os.system("cp hists/yield_AN_sr_sys_010222_nominal_nosys/combine/data.root hists/"+tag[0]+"/combine/data.root")
    os.system("cp hists/yield_AN_sr_sys_010222_nominal_nosys/2016/data.root hists/"+tag[0]+"/2016/data.root") ## copy the nominal data file here
    os.system("cp hists/yield_AN_sr_sys_010222_nominal_nosys/2017/data.root hists/"+tag[0]+"/2017/data.root") ## copy the nominal data file here
    os.system("cp hists/yield_AN_sr_sys_010222_nominal_nosys/2018/data.root hists/"+tag[0]+"/2018/data.root") ## copy the nominal data file here       
