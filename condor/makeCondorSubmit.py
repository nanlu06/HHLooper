...
for year in ["2016","2017","2018"]:
    condorout = "mkdir /storage/af/user/idutta/HH/CMSSW_9_4_2/src/V2/HHLooper/condor/condor_output/yield_AN_sr_sys_180122_300_nominal_nosys_data"
    os.system(condorout)
    condorout = "mkdir /storage/af/user/idutta/HH/CMSSW_9_4_2/src/V2/HHLooper/condor/condor_output/yield_AN_sr_sys_180122_300_nominal_nosys_data/"+year
    os.system(condorout)
