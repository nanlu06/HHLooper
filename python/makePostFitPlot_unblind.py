...
def main(vbdt, HH_limit):
    ...
    for dirName in ["shapes_prefit",  "shapes_fit_s",  "shapes_fit_b"]:
        ...
        if dirName == "shapes_fit_b":
            HH_limit = 0.0
        pnames_bkg = ["ttH_hbb", "VH_bb", "bbbb_boosted_ggf_others", "ttbar", "qcd","qqHH_CV_1_C2V_1_kl_1_hbbhbb","ggHH_kl_1_kt_1_hbbhbb"]
        ...
        for bdtbin in bdtbins:
            ...
            fin_sig = r.TFile("combined_cards_"+vbdt+"/fitDiagnostics"+region+".root", "READ")
            h1_sig = []
            h1_bkg = []
            h1_data = None
...
if __name__ == "__main__":
    vbdt = "v8p2yield_AN_sr_sys_1111v2"
