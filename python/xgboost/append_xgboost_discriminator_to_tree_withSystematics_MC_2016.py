...
my_s_JESUp_Abs_2016 = MyStruct()
my_s_JESDown_Abs_2016 = MyStruct()
my_s_JESUp_BBEC1 = MyStruct()
my_s_JESDown_BBEC1 = MyStruct()
my_s_JESUp_BBEC1_2016 = MyStruct()
my_s_JESDown_BBEC1_2016 = MyStruct()
my_s_JESUp_EC2 = MyStruct()
my_s_JESDown_EC2 = MyStruct()
my_s_JESUp_EC2_2016 = MyStruct()
my_s_JESDown_EC2_2016 = MyStruct()
my_s_JESUp_HF = MyStruct()
my_s_JESDown_HF = MyStruct()
my_s_JESUp_HF_2016 = MyStruct()
my_s_JESDown_HF_2016 = MyStruct()
my_s_JESUp_FlavQCD = MyStruct()
my_s_JESDown_FlavQCD = MyStruct()
my_s_JESUp_RelBal = MyStruct()
my_s_JESDown_RelBal = MyStruct()
my_s_JESUp_RelSample_2016 = MyStruct()
my_s_JESDown_RelSample_2016 = MyStruct()
my_s_JMSUp = MyStruct()
...
branch_disc_JESUp_Abs_2016 = outputTree.Branch(_disc_var_name+"_JESUp_Abs_2016",root.addressof(my_s_JESUp_Abs_2016,'disc'), _disc_var_name+'_JESUp_Abs_2016/F');
branch_disc_JESDown_Abs_2016 = outputTree.Branch(_disc_var_name+"_JESDown_Abs_2016",root.addressof(my_s_JESDown_Abs_2016,'disc'), _disc_var_name+'_JESDown_Abs_2016/F');
...
branch_disc_JESUp_BBEC1_2016 = outputTree.Branch(_disc_var_name+"_JESUp_BBEC1_2016",root.addressof(my_s_JESUp_BBEC1_2016,'disc'), _disc_var_name+'_JESUp_BBEC1_2016/F');
branch_disc_JESDown_BBEC1_2016 = outputTree.Branch(_disc_var_name+"_JESDown_BBEC1_2016",root.addressof(my_s_JESDown_BBEC1_2016,'disc'), _disc_var_name+'_JESDown_BBEC1_2016/F');
...
branch_disc_JESUp_EC2_2016 = outputTree.Branch(_disc_var_name+"_JESUp_EC2_2016",root.addressof(my_s_JESUp_EC2_2016,'disc'), _disc_var_name+'_JESUp_EC2_2016/F');
branch_disc_JESDown_EC2_2016 = outputTree.Branch(_disc_var_name+"_JESDown_EC2_2016",root.addressof(my_s_JESDown_EC2_2016,'disc'), _disc_var_name+'_JESDown_EC2_2016/F');
...
branch_disc_JESUp_HF_2016 = outputTree.Branch(_disc_var_name+"_JESUp_HF_2016",root.addressof(my_s_JESUp_HF_2016,'disc'), _disc_var_name+'_JESUp_HF_2016/F');
branch_disc_JESDown_HF_2016 = outputTree.Branch(_disc_var_name+"_JESDown_HF_2016",root.addressof(my_s_JESDown_HF_2016,'disc'), _disc_var_name+'_JESDown_HF_2016/F');
...
branch_disc_JESUp_RelSample_2016 = outputTree.Branch(_disc_var_name+"_JESUp_RelSample_2016",root.addressof(my_s_JESUp_RelSample_2016,'disc'), _disc_var_name+'_JESUp_RelSample_2016/F');
branch_disc_JESDown_RelSample_2016 = outputTree.Branch(_disc_var_name+"_JESDown_RelSample_2016",root.addressof(my_s_JESDown_RelSample_2016,'disc'), _disc_var_name+'_JESDown_RelSample_2016/F');
...
for i in range(nEntries):
    ...
    ################ JES Up Abs_2016  ###################
    tmpXList[0] = inputTree.hh_pt_JESUp_Abs_2016 #new ntuples didn't have this
    tmpXList[1] = inputTree.hh_eta_JESUp_Abs_2016
    tmpXList[2] = inputTree.hh_mass_JESUp_Abs_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESUp_Abs_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESUp_Abs_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESUp_Abs_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESUp_Abs_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESUp_Abs_2016.disc = tmpY

    ################ JES Down Abs_2016 ###################
    tmpXList[0] = inputTree.hh_pt_JESDown_Abs_2016
    tmpXList[1] = inputTree.hh_eta_JESDown_Abs_2016
    tmpXList[2] = inputTree.hh_mass_JESDown_Abs_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESDown_Abs_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESDown_Abs_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESDown_Abs_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESDown_Abs_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESDown_Abs_2016.disc = tmpY
    ...
    ################ JES Up BBEC1_2016  ###################
    tmpXList[0] = inputTree.hh_pt_JESUp_BBEC1_2016 #new ntuples didn't have this
    tmpXList[1] = inputTree.hh_eta_JESUp_BBEC1_2016
    tmpXList[2] = inputTree.hh_mass_JESUp_BBEC1_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESUp_BBEC1_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESUp_BBEC1_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESUp_BBEC1_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESUp_BBEC1_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESUp_BBEC1_2016.disc = tmpY

    ################ JES Down BBEC1_2016 ###################
    tmpXList[0] = inputTree.hh_pt_JESDown_BBEC1_2016
    tmpXList[1] = inputTree.hh_eta_JESDown_BBEC1_2016
    tmpXList[2] = inputTree.hh_mass_JESDown_BBEC1_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESDown_BBEC1_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESDown_BBEC1_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESDown_BBEC1_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESDown_BBEC1_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESDown_BBEC1_2016.disc = tmpY
    ...
    ################ JES Up EC2_2016  ###################
    tmpXList[0] = inputTree.hh_pt_JESUp_EC2_2016 #new ntuples didn't have this
    tmpXList[1] = inputTree.hh_eta_JESUp_EC2_2016
    tmpXList[2] = inputTree.hh_mass_JESUp_EC2_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESUp_EC2_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESUp_EC2_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESUp_EC2_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESUp_EC2_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESUp_EC2_2016.disc = tmpY

    ################ JES Down EC2_2016 ###################
    tmpXList[0] = inputTree.hh_pt_JESDown_EC2_2016
    tmpXList[1] = inputTree.hh_eta_JESDown_EC2_2016
    tmpXList[2] = inputTree.hh_mass_JESDown_EC2_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESDown_EC2_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESDown_EC2_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESDown_EC2_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESDown_EC2_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESDown_EC2_2016.disc = tmpY
    ...
    ################ JES Up HF_2016  ###################
    tmpXList[0] = inputTree.hh_pt_JESUp_HF_2016 #new ntuples didn't have this
    tmpXList[1] = inputTree.hh_eta_JESUp_HF_2016
    tmpXList[2] = inputTree.hh_mass_JESUp_HF_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESUp_HF_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESUp_HF_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESUp_HF_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESUp_HF_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESUp_HF_2016.disc = tmpY

    ################ JES Down HF_2016 ###################
    tmpXList[0] = inputTree.hh_pt_JESDown_HF_2016
    tmpXList[1] = inputTree.hh_eta_JESDown_HF_2016
    tmpXList[2] = inputTree.hh_mass_JESDown_HF_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESDown_HF_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESDown_HF_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESDown_HF_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESDown_HF_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESDown_HF_2016.disc = tmpY
    ...
    ################ JES Up RelSample_2016  ###################
    tmpXList[0] = inputTree.hh_pt_JESUp_RelSample_2016 #new ntuples didn't have this
    tmpXList[1] = inputTree.hh_eta_JESUp_RelSample_2016
    tmpXList[2] = inputTree.hh_mass_JESUp_RelSample_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESUp_RelSample_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESUp_RelSample_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESUp_RelSample_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESUp_RelSample_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESUp_RelSample_2016.disc = tmpY

    ################ JES Down RelSample_2016 ###################
    tmpXList[0] = inputTree.hh_pt_JESDown_RelSample_2016
    tmpXList[1] = inputTree.hh_eta_JESDown_RelSample_2016
    tmpXList[2] = inputTree.hh_mass_JESDown_RelSample_2016
    tmpXList[7] = inputTree.fatJet1Pt_JESDown_RelSample_2016 #for new ntuples
    tmpXList[13] = inputTree.fatJet2Pt_JESDown_RelSample_2016 #for new ntuples
    tmpXList[14] = inputTree.fatJet1PtOverMHH_JESDown_RelSample_2016
    tmpXList[15] = inputTree.fatJet2PtOverMHH_JESDown_RelSample_2016
    tmpXNPArray = np.array([ tmpXList ])
    tmpY = model.predict_proba(tmpXNPArray)[:, 1]
    my_s_JESDown_RelSample_2016.disc = tmpY
